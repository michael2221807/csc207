 ...
 * example/udu/a1assignement/GameEngine.java
 * The main manager for Connect4 game board.
 */
public class GridManager implements Serializable {
    ...
    public int[] gameEnd;
    protected ArrayList<Integer> win;

    protected boolean finished=false;



    protected GridManager(int rows, int columns){
    ...
    public ArrayList<Integer> getAlAddPos(){
        return this.al_addPos;
    }
    public void setAlAddPos(ArrayList<Integer> Pos) {
        this.al_addPos = Pos;
